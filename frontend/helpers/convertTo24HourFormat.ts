...
const convertTo24HourFormat = (restrictionTime: RestrictionTime): string => {
    ...
    */
    ...
    else if (formattedMinutes < 0 || formattedMinutes > 59) {
        throw new Error('Minutes must be between 0 and 59');
    }
    else if (formattedHours < 0 || formattedHours > 23) {
        throw new Error('Hours must be between 0 and 23');
    }
    else if (amOrPm !== 'AM' && amOrPm !== 'PM') {
    ...
    else if (amOrPm === 'PM' && formattedHours > 12) {
